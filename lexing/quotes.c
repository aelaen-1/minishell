...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/31 10:14:31 by glabaden          #+#    #+#             */
/*   Updated: 2025/01/31 10:14:33 by glabaden         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	handle_quote(char *start_quote, t_token *token, t_lex_context *context)
{
	...
	next_quote = ft_strchr(start_quote + 1, *start_quote);
	if (next_quote != NULL)
	{
		quote_len = next_quote - start_quote + 1;
...
static void	change_state_if_next_quote(char *s,
		t_quote_type *current, int first_quote_type)
{
